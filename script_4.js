...
for (let i in entrepreneurs)
    result2.push({ first: entrepreneurs[i].first, last: entrepreneurs[i].last });
console.log(result2);

console.log("Quel âge aurait chaque inventeur aujourd'hui ?")
for (let i in entrepreneurs) {
    let age = 2022 - entrepreneurs[i].year;
    console.log("Mr " + entrepreneurs[i].last + " " + entrepreneurs[i].first + ' aurait/a ' + age + " ans aujourd'hui");
};
